    ...
    <div class="gva-card-box">
      <div class="gva-card gva-top-card">
        <div class="gva-top-card-left">
          <div class="gva-top-card-left-title">Welcome to MCM Club Manager</div>
          <div class="gva-top-card-left-dot">{{ weatherInfo }}</div>
          <div class="gva-top-card-left-rows">
            <el-row>
<!--              <el-col :span="20" :xs="24" :sm="8">-->
                <div class="flex-center">
                  本系统是同济大学数学建模协会的工作系统，仅供内部使用
          ...
          <div>
            <div class="gva-top-card-left-item">
              ...
              <a
                style="color:#409EFF"
                target="view_window"
                href="https://math.tongji.edu.cn/mathen/xygl/xyjj.htm"
              >https://math.tongji.edu.cn/mathen/xygl/xyjj.htm</a>
            </div>
<!--            <div class="gva-top-card-left-item">-->
<!--              插件仓库：-->
<!--              <a-->
