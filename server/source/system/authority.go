...
func (i *initAuthority) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []sysModel.SysAuthority{
		{AuthorityId: "888", AuthorityName: "会长", ParentId: "0", DefaultRouter: "dashboard"},
		{AuthorityId: "9528", AuthorityName: "部长", ParentId: "0", DefaultRouter: "dashboard"},
		{AuthorityId: "8881", AuthorityName: "普通成员", ParentId: "888", DefaultRouter: "dashboard"},
	}
